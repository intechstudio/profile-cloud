                    ...
                    <li>
                        <button
                            class="block px-2 py-1 {configTypeSelector === 'profile'
                                ? 'bg-emerald-600'
                                : ''}"
                            on:click={() => (configTypeSelector = "profile")}>Profiles</button
                        >
                    </li>
                    <li>
                        <button
                            class="block px-2 py-1 {configTypeSelector === 'preset'
                                ? 'bg-emerald-600'
                                : ''}"
                            on:click={() => (configTypeSelector = "preset")}>Presets</button
                        >
                    </li>
                </ul>
                <div class="py-4 flex items-center justify-between">
                    <div class="flex flex-col">
                        ...
                        <div class="text-white text-opacity-60">
                            Public {configTypeSelector}s from others and save yours as private or
                            public here.
                        </div>
                    </div>
                    <button
                        ...
                        >
                            <div class="group w-full flex flex-col text-left py-4">
                                {#if usernameInput.exists == false}
                                    <div class="pb-2">
                                        Before using the cloud, enter a username which will be
                                        displayed with your public profiles.
                                    </div>
                                {:else}
                                    <div>
